...
//♭ℛÜℕѺ
		...
		{
			localObject = "SYSCUSKik TaAuU (Terms and Agreement(s) upon Usage) [DISCLAIMER]: Upon downloading and/or installation and/or Usage of SYSCUSKik, you understand that this is a modified version of Kik. The same agreements, licenses, terms, and other authorative information, duties, regulations, responsibilities, and the alike of Kik Interactive and Kik Messenger, still apply; whether the the information is provided or not; in case that in the modding proccess of SYSCUSKik, such information may or was removed/not present/visible/acknowledged or rendered such as being unavailable. Kik Interactive owns the rights to Kik Messenger; any copy/mod/variant of official Kik-related software; or of SYSCUSKik, is as is, and is not in any way associated or related to SYSCUSKik. The ONLY recognized information, links, etc. as Officially being of SYSCUSKik exists here: https://sites.google.com/site/TheSYSCUSRP/Home/SYSCUSKik-Legitimate-Authenticity-Statement/ and, therefore, any other such information, links, etc. is NOT Official. SYSCUSKik does not encourage or promote the influence of negative, malicious, harmful use and engagements, we (of the S.I.P. [Programmers]) will act with offical Kik services if needed. You understand, agree, and signify respect to all of the informatin provided by continuing to use SYSCUSKik. While also using SYSCUSKik, you also agree and understand that we (of the S.I.P. [Programmers]) can; at any time, alter, change, modify, promote, recall, revise, and enact any other such actions to SYSCUSKik and the things of it; including this agreement, without your ackowledgement.";
		}
...
//Functions
        ...
        {
          localObject = " ﻿Sorry, this freature is available yet.";
        }
...
//END Custom Commands
        ...
        else if ((str.toLowerCase().startsWith("!d ")) && (str.length() >= 2))
        {
